...
const weatherBitKey = "aa14f8d9f986400199587a42e6167e1d";
const pixabayUrl = "https://pixabay.com/api/?key=";
const pixabayKey = "21921033-23cd9cf70ee288239e0f64dbb";
...
function handleSubmit(e) {
    ...
    details['from'] = document.getElementById("departure_city").value;
    details['to'] = document.getElementById("arrival_city").value;
    details['date'] = document.getElementById("departureDate").value;
...
async function getImage(toCity) {
    const response = await fetch(pixabayUrl + pixabayKey + '&q=' + toCity + ' city&image_type=photo');
    try {
        return await response.json();
    } catch (e) {
        console.log('error', e);
